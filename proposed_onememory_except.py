...
def plot_history(epochs, acc, i, figure_name='onememory_except_complete'):
...
for i in range(2):
    ...
    for episode in range(NUM_EPISODES):
        ...
        # if episode % 100 == 0:
            mainQN.model.save_weights(DIR_PATH+f'check_points/my_checkpoint_onememory_except_complete_{episode}_{i}')

        # print(name_select_list)
        # print(feature_select_list)
    np.save(DIR_PATH + 'numpy/' + f'proposed_onememory_except_complete_name_{NUM_EPISODES}_{i}.npy', name_select_list)
    np.save(DIR_PATH + 'numpy/' + f'proposed_onememory_except_complete_feature_{NUM_EPISODES}_{i}.npy', feature_select_list)

    np.save(DIR_PATH + 'numpy/' + f'proposed_onememory_except_complete_acc_{NUM_EPISODES}_{i}.npy', acc)
    np.save(DIR_PATH + 'numpy/' + f'proposed_onememory_except_complete_epochs_{NUM_EPISODES}_{i}.npy', epochs)

    mainQN.model.save_weights(DIR_PATH+f'check_points/my_checkpoint_onememory_except_complete_{NUM_EPISODES}_{i}')
