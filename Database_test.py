...
class Database():
    def __init__(self, div_size):
        global use_color, use_size, use_shape, use_taste, use_hardness, use_move, use_verb
        self.data = pd.read_csv("./make_table-master/densetrack_create_takeshita/main_new.csv", index_col=0)
        ...
        if(use_taste):
            ...
            self.taste_size = 0
        if(use_move):
            move_all = pd.read_csv("./make_table-master/densetrack_create_takeshita/new_move_k_medoids_100_30.csv", index_col=0)
